...
Im Mittel sind es 
\begin{equation}
\Gamma_{l\bar{l}} = \SI{16+-7}{}
\end{equation}
Diese weichen stark voneinander ab, mit einer Standartabweichung von 40~\%.
...
\end{equation}
Da die Zerfallsbreite proportional zu der Ereigniszahl ist, konnten diese verwenden werden, ohne die Zerfallsbreiten zu bestimmen.
...
Da diese sich auch auf die Farbzahl auswirkt, war der tatsächliche Fehler größer.
