...
\begin{equation}
\label{eq:kalib}
\mu(U_{\mathrm{SQUID}}) = \frac{2 \uppi  x^3 }{\mu_{\rm{0}}} \cdot  \left( \SI{18+-3}{\micro \tesla \per \mV}  \cdot U_{\mathrm{SQUID}}~.
\end{equation}
...
Auch für den senkrechten Einbau weichen die Messreihen der ohne Magnetfeld und der im Feld gekühlten Probe nicht stark voneinander ab.
...
Abbildung~\ref{fig:neukurve} zu sehende Neukurve.
...
\begin{figure}[tbh!]
  ...
  \caption{\textbf{Neukurve von Tb bei 120 Kelvin.} Zu sehen sind die
    in die Messpunkte und von uns gewählte
...
Die Punkte stellen die Messwerte da, außerdem sind nach Augenmaß
gewählte Verbingungslinien zu sehen. 
Offensichtlich ist, dass die Magnetisierung von Tb
