...
Mithilfe der gegebenen Analyse-Software wird der Membranstrom histogrammiert. 
...
Nun soll eine solche Menge von Gramicidin A hinzugefügt werden, dass man mehrere Ionenkanäle erhält, sodass die Grundlinie nicht mehr sichtbar ist und keine Stufen im Strom mehr enthalten sind. 
Der Mittelwert der Stromfluktuation sollte konstant bleiben, da sonst die Gleichungen für die Autokorrelation nicht gültig wären. 
Nun soll eine Analyse mit der Autokorrelationsfunktion durchgeführt werden und
