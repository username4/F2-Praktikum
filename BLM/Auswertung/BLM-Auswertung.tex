...
\begin{figure}[tbh!]
  ...
  \begin{minipage}[b]{.6\textwidth}
    ...
    \subcaption{Histogrammierung der Ströme aus Abbildung\ref{fig:einkanalfail-autocorr}.}
...
Jedes Maximum entspricht einer Anzahl an geöffneten Kanälen. Da der Strom nur quantisiert durch sie fließt, entstehen Maxima, an denen die Werte für den Strom bevorzugt sind.
...
Dieses Ergebnis weicht um mehr als einen Faktor 10 vom Einkanalstrom aus Aufgabe 2 ab. Dies bedeutet, dass die Leitfähigkeit eines Kanals mit steigender Kanalzahl zunimmt. Es ist aber nicht auszuschließen, dass es sich bei den beobachteten Maxima nur um Rauschen handelt. Aufgrund der kurzen Messung waren sie nur schwer erkennbar. Ein Einkanalstrom von nur wenigen Picoampère  lässt sich bei einer solch kurzen Messung nicht auflösen. Histogramme sind bei hohen Konzentrationen ungeeignet, um den Einzelkanalstrom zu bestimmen.
...
Mögliche Gründe der Abweichung wurden in Aufgabe 3 diskutiert.
